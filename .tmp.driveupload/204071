          ...
          if(dataType == "int" || dataType == "bigint" || dataType == "float" || dataType == "decimal" || dataType == "money"){
            ...
            if(editData.length > 0){
              ...
              if(editData[1] == 1){
                ...
                // Check if the column name is 'sport'
                if (colName === 'sport') {
                    cellEditorParams = {
                        values: ["Swimming", "Gymnastics", "Cycling", "Ski Jumping"], // Dropdown options for 'sport'
                        valueListMaxHeight: 120, // Optional: Adjust dropdown height
                    };
                    ...
                    colDefs.push({
                        ...
                        cellEditor: "agRichSelectCellEditor", // Use dropdown editor
