...
const gridOptions = {
  ...
  onCellEditingStopped: (params) => {
    if (isPinnedRowDataCompleted(params)) {
      console.log("Pinned row data completed. Saving data...");
      ...
      // Save data to server or perform any additional actions
...
function isPinnedRowDataCompleted(params) {
  ...
  return columnDefs.every((def) => params.data[def.field]);
}
              ...
              if (colName === 'sport') {
                  ...
                  fetchSportOptions().then((sports) => {
                      ...
                      colDefs.push({
                          ...
                          valueSetter: (params) => {
                              console.log("In string section 1");
                              console.log("Value Setter", params);
                              const newValue = params.newValue;
