		...
		<section class="panel">
			...
			<div class="panel-body" id="datatable">
				...
				<table class="table table-bordered table-striped mb-none" id="datatable-table" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
					...
					<thead>
					<th>Sr. No.</th>
					<!-- <th><input type="search" id="pid" name="pid" placeholder="pid"></th> -->
					<th><input type="search" id="bname" name="bname" placeholder="bname"></th>
					<th><input type="search" id="cntl" name="cntl" placeholder="cntl"></th>
