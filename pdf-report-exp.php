            ...
            success: function(data) {
                ...
                if(data.data.length > 5){
                    ...
                    if(exporttype == '' || exporttype == '31' || exporttype == 31){
                        ...
                        $('#pdfviewer').append('<div id="pdfviewer" style="text-align: center;margin-top: 50px;"><a href="'+pdflink+'" download class="btn btn-primary" >DOWNLOAD GENERATED REPORT</a></div>');
                    }
                }else{
